/**
 * Simple Offline Status Indicator - Hozirgi loyihaga to'liq mos
 * 
 * Faqat mavjud hook'lar va kutubxonalar bilan ishlaydi
 */
...
interface OfflineStatusSimpleProps {
  pendingCount?: number;
  onSyncNow?: () => void;
  className?: string;
}

export const OfflineStatusSimple: React.FC<OfflineStatusSimpleProps> = ({
  pendingCount = 0,
  onSyncNow,
  className = ''
}) => {
      ...
      `}>
        ...
        <div className="flex-1 min-w-0">
          ...
          {pendingCount > 0 && (
            <div className="flex items-center gap-1 text-xs mt-1">
              ...
              <span>
                {pendingCount} {t('kutilayotgan operatsiya', language)}
              </span>
            </div>
          )}
        </div>
        ...
        {isOnline && pendingCount > 0 && (
          <button
            ...
            `}
            title={t("Hozir sinxronlash", language)}
          >
...
export default OfflineStatusSimple;